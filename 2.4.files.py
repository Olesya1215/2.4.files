        ...
        try:
            for ingredient in cook_book.get(dish):
                if ingredient["ingredient_name"] not in dictionary_of_ingredients:
                    ...
                    dictionary_of_ingredients[ingredient["ingredient_name"]]["quantity"] = dictionary_of_ingredients[ingredient["ingredient_name"]]["quantity"] + int(ingredient["quantity"]) * person_count
        except TypeError:
